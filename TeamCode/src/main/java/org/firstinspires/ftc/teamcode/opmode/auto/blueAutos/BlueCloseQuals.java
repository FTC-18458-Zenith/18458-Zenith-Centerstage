...
@Autonomous
public class BlueCloseQuals extends MatchOpMode {
    ...
    public static class BlueCloseConstants {
        ...
        public static class Path {
            ...
            public static class Park {
                ...
                static TrajectorySequenceContainer park = new TrajectorySequenceContainer(BlueCloseConstants.Speed::getBaseConstraints, b);
            }
        }
