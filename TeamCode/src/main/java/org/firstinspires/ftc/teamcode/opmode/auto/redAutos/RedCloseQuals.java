...
@Autonomous
public class RedCloseQuals extends MatchOpMode {
    ...
    public void matchStart() {
        ...
        switch (vision.getFinalPosition()) {
            case LEFT:
                finalX = RedCloseConstants.Path.PurplePixel.leftX;
                RedCloseConstants.Path.PurplePixel.autoPosition = RedCloseConstants.Path.PurplePixel.autoPosition.lEFT;
                break;
            case MIDDLE:
                finalX = RedCloseConstants.Path.PurplePixel.leftX;
                RedCloseConstants.Path.PurplePixel.autoPosition = RedCloseConstants.Path.PurplePixel.autoPosition.MID;
                break;
            case RIGHT:
                finalX = RedCloseConstants.Path.PurplePixel.leftX;
                RedCloseConstants.Path.PurplePixel.autoPosition = RedCloseConstants.Path.PurplePixel.autoPosition.RIGHT;
                break;
        }
    ...
    public static class RedCloseConstants {
        ...
        public static class Path {
            ...
            public static class Park {
                public static LineToConstantHeading a = new LineToConstantHeading(49, -65);
                public static LineToConstantHeading b = new LineToConstantHeading(46, -8);
                static TrajectorySequenceContainer park = new TrajectorySequenceContainer(RedCloseConstants.Speed::getBaseConstraints, b);
            }
        }
