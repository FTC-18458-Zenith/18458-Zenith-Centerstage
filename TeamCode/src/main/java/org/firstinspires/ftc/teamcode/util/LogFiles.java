...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double ticksPerRev = WhyDoWeHave2DriveConstants.TICKS_PER_REV;
        public double maxRpm = WhyDoWeHave2DriveConstants.MAX_RPM;
        public boolean runUsingEncoder = WhyDoWeHave2DriveConstants.RUN_USING_ENCODER;
        public double motorP = WhyDoWeHave2DriveConstants.MOTOR_VELO_PID.p;
        public double motorI = WhyDoWeHave2DriveConstants.MOTOR_VELO_PID.i;
        public double motorD = WhyDoWeHave2DriveConstants.MOTOR_VELO_PID.d;
        public double motorF = WhyDoWeHave2DriveConstants.MOTOR_VELO_PID.f;
        public double wheelRadius = WhyDoWeHave2DriveConstants.WHEEL_RADIUS;
        public double gearRatio = WhyDoWeHave2DriveConstants.GEAR_RATIO;
        public double trackWidth = WhyDoWeHave2DriveConstants.TRACK_WIDTH;
        public double kV = WhyDoWeHave2DriveConstants.kV;
        public double kA = WhyDoWeHave2DriveConstants.kA;
        public double kStatic = WhyDoWeHave2DriveConstants.kStatic;
        public double maxVel = WhyDoWeHave2DriveConstants.MAX_VEL;
        public double maxAccel = WhyDoWeHave2DriveConstants.MAX_ACCEL;
        public double maxAngVel = WhyDoWeHave2DriveConstants.MAX_ANG_VEL;
        public double maxAngAccel = WhyDoWeHave2DriveConstants.MAX_ANG_ACCEL;
        ...
        public RevHubOrientationOnRobot.LogoFacingDirection LOGO_FACING_DIR = WhyDoWeHave2DriveConstants.LOGO_FACING_DIR;
        public RevHubOrientationOnRobot.UsbFacingDirection USB_FACING_DIR = WhyDoWeHave2DriveConstants.USB_FACING_DIR;
