...
public class MaxVelocityTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double effectiveKf = WhyDoWeHave2DriveConstants.getMotorVelocityF(veloInchesToTicks(maxVelocity));
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return inchesPerSec / (2 * Math.PI * WhyDoWeHave2DriveConstants.WHEEL_RADIUS) / WhyDoWeHave2DriveConstants.GEAR_RATIO * WhyDoWeHave2DriveConstants.TICKS_PER_REV;
    }
}
